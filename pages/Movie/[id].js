  ...
  return (
    ...
    <Navbar/>
      ...
      <Box sx={{padding:"10px"}}>
        ...
        <Box
        sx={{backgroundImage:`url(https://image.tmdb.org/t/p/original${a.backdrop_path})`,height:"80vh",backgroundRepeat:"no-repeat",backgroundSize:'cover'}}
        >
                ...
                <Grid item xs={6} md={6}>
                    <Box sx={{padding:"30px",display:'flex',flexDirection:"column",height:"80vh",background:"black",opacity:"0.9",boxShadow:"0px 0px 100px 10px rgba(0,0,0,0.1)",zIndex:0,borderRadius:"100p"}}>
                      ...
                      <Typography sx={{fontSize:"15px",color:"gray",fontWeight:"800",padding:"10px"}}>{a.overview}</Typography>
                       ...
                       <DataBox type={"Budget"} value={a.budget} />
                       <DataBox type={"Popularity"} value={a.popularity} />
                       <DataBox type={"revenue"} value={a.revenue} />
